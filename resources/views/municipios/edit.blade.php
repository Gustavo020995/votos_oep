                        ...
                        <div class="card-body">
                                ...
                                <select class="form-control" id="provincia_id" name="provincia_id" required>
                                    ...
                                    @foreach($provincias as $provincia)
                                        <option value="{{ $provincia->id }}" 
                                            {{ old('provincia_id', $municipio->provincia_id) == $provincia->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="codigo" name="codigo" 
                                       value="{{ old('codigo', $municipio->codigo) }}" required>
                                @error('codigo')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="total_inscritos" name="total_inscritos" 
                                       value="{{ old('total_inscritos', $municipio->total_inscritos) }}" min="0" required>
